...
package myApp.soapProxy.lpi.server.soap;
 ...
 * generated in the lpi.server.soap package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: lpi.server.soap
     * 
     */
